...
# Requiremnts jq
# flush before running whole script
...
#curl -X GET http://127.0.0.1:8000/tags/read/2/  -H "Content-Type: application/json"  -H "Authorization: Bearer $ACCESS" 

#curl -s -X POST http://127.0.0.1:8000/tags/create/tag/1/post/10/ -H "Content-Type: application/json" -H "Authorization: Bearer $ACCESS" | jq

#curl -s -X  GET http://127.0.0.1:8000/tags/list/post-tags/2/  -H "Content-Type: application/json"  -H "Authorization: Bearer $ACCESS" | jq

#curl -s -X GET http://127.0.0.1:8000/tags/list/tags/  -H "Content-Type: application/json"  -H "Authorization: Bearer $ACCESS" | jq
...
#curl -s -X POST http://127.0.0.1:8000/comment/create/4/  -H "Content-Type: application/json"  -d '{"body": "Nice post!",  "guestname": "bob",  "created_at": "2025-10-28T09:30:00Z" }' | jq

#curl -s -X POST http://127.0.0.1:8000/comment/create/4/  -H "Content-Type: application/json"  -H "Authorization: Bearer $ACCESS"  -d '{  "body": "Author here thanks for reading!", "guestname": "bob",  "created_at": "2025-10-28T09:35:00Z" }' | jq

#curl -s -X GET http://127.0.0.1:8000/comment/list/4/ -H "Accept: application/json" | jq
